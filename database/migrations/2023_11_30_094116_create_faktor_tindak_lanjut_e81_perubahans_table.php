...
class CreateFaktorTindakLanjutE81PerubahansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('faktor_tindak_lanjut_e81_perubahans', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('faktor_tindak_lanjut_e81_perubahans');
    }
}
