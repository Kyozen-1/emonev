...
<div class="container">
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Misi</h1>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="misi_table" class="data-table w-100">
                <thead>
                    <tr>
                        <th class="text-muted text-small text-uppercase" width="10%">No</th>
                        <th class="text-muted text-small text-uppercase" width="30%">Visi</th>
                        <th class="text-muted text-small text-uppercase" width="10%">Kode</th>
                        <th class="text-muted text-small text-uppercase" width="30%">Misi</th>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-7">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Misi</label>
                            <textarea id="detail_deskripsi" class="form-control" rows="5" disabled></textarea>
                        </div>
                    </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTables = $('#misi_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.misi.index') }}",
                },
                columns:[
                    {
                        data: 'DT_RowIndex'
                ...
                $.ajax({
                    ...
                    success: function(data)
                    {
                        ...
                        if(data.errors)
                        {
                            ...
                            $("[name='visi_id']").val('').trigger('change');
                            $('#aksi_button').text('Save');
                            $('#misi_table').DataTable().ajax.reload();
                        }
                        if(data.success)
                        {
