...
<div class="container">
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align: right">
            ...
            <a class="btn btn-outline-success waves-effect waves-light mr-2" href="{{ asset('template/template_impor_sasaran.xlsx') }}" title="Download Template Import Data"><i class="fas fa-file-excel"></i></a>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="sasaran_table" class="data-table w-100">
                <thead>
                    <tr>
                        <th class="text-muted text-small text-uppercase" width="10%">No</th>
                        <th class="text-muted text-small text-uppercase" width="10%">Kode Misi</th>
                        <th class="text-muted text-small text-uppercase" width="10%">Kode Tujuan</th>
                        <th class="text-muted text-small text-uppercase" width="10%">Kode</th>
                        <th class="text-muted text-small text-uppercase" width="30%">Deskripsi</th>
                        <th class="text-muted text-small text-uppercase" width="10%">Indikator</th>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-4">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Tujuan</label>
                            <textarea id="detail_tujuan" class="form-control" rows="5" disabled></textarea>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Kode</label>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            ...
                            <div id="div_pivot_sasaran_indikator" class="scrollBarPagination"></div>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            var dataTables = $('#sasaran_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('admin.sasaran.index') }}",
                },
                columns:[
                    {
                        data: 'DT_RowIndex'
        ...
        $(document).on('click', '.detail', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('#pivot_sasaran_indikator').remove();
                    $('#div_pivot_sasaran_indikator').append('<div id="pivot_sasaran_indikator"></div>');
                    ...
                    $('#detail_tujuan').val(data.result.tujuan);
                    ...
                    $('#pivot_sasaran_indikator').append(data.result.pivot_sasaran_indikator);
        ...
        $('#visi_id').on('change', function(){
            ...
            {
                $.ajax({
                    url: "{{ route('admin.sasaran.get-misi') }}",
                    method: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id:$(this).val()
        ...
        $('#misi_id').on('change', function(){
            ...
            {
                $.ajax({
                    url: "{{ route('admin.sasaran.get-tujuan') }}",
                    method: 'POST',
                    data: {
                        "_token": "{{ csrf_token() }}",
                        id:$(this).val()
                    ...
                    success: function(response){
                        ...
                        if(tujuan_id != 0)
                        {
                            $("[name='tujuan_id']").val(tujuan_id).trigger('change');
                        }
                    }
                });
            }
        ...
        $(document).on('click', '.edit', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    tujuan_id = data.result.tujuan_id;
                    $('#hidden_id').val(id);
        ...
        $(document).on('click', '.delete',function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ url('/admin/sasaran/destroy') }}" + '/' + id,
                        dataType: "json",
                        beforeSend: function()
                        {
                            return new swal({
