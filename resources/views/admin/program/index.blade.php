...
<div class="container">
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align: right">
            ...
            <a class="btn btn-outline-success waves-effect waves-light mr-2" href="{{ asset('template/template_impor_program.xlsx') }}" title="Download Template Import Data"><i class="fas fa-file-excel"></i></a>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="program_table" class="data-table w-100">
                <thead>
                    <tr>
                        ...
                        <th class="text-muted text-small text-uppercase">Pagu</th>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-12 col-md-4">
                        ...
                        <div class="mb-3">
                            <label for="" class="form-label">Pagu</label>
                            <input type="text" class="form-control" id="detail_pagu" disabled>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
                            <label for="" class="form-label">Program Indikator</label>
                            <div id="div_pivot_program_indikator" class="scrollBarPagination"></div>
                        </div>
                    </div>
                    <div class="col-12 col-md-4">
                        <div class="mb-3">
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTables = $('#program_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
        ...
        $(document).on('click', '.detail', function(){
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    $('#pivot_program_indikator').remove();
                    $('#div_pivot_program_indikator').append('<div id="pivot_program_indikator"></div>');
                    ...
                    $('#detail_pagu').val(data.result.pagu);
                    $('#pivot_perubahan_program').append(data.result.pivot_perubahan_program);
                    $('#pivot_program_indikator').append(data.result.pivot_program_indikator);
        ...
        $(document).on('click', '.delete',function(){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ url('/admin/program/destroy') }}" + '/' + id,
                        dataType: "json",
                        beforeSend: function()
                        {
                            return new swal({
