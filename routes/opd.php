...
Route::group(['middleware' => 'auth:opd'], function(){
    ...
    // Renstra Start
        ...
        Route::get('/opd/renstra/get-sub-kegiatan', 'Opd\RenstraController@get_sub_kegiatan')->name('opd.renstra.get-sub-kegiatan');
        ...
        Route::post('/opd/renstra/filter-get-sub-kegiatan', 'Opd\RenstraController@filter_get_sub_kegiatan')->name('opd.renstra.filter-get-sub-kegiatan');
        ...
        Route::post('/opd/renstra/filter/get-sub-kegiatan', 'Opd\RenstraController@get_filter_sub_kegiatan')->name('opd.renstra.filter.get-sub-kegiatan');
        Route::post('/opd/renstra/reset/get-sub-kegiatan', 'Opd\RenstraController@get_sub_kegiatan')->name('opd.renstra.reset.get-sub-kegiatan');
        ...
        Route::post('/opd/renstra/sub-kegiatan/get-data', 'Opd\SubKegiatanController@get_data')->name('opd.renstra.sub-kegiatan.get-data');
        Route::post('/opd/renstra/sub-kegiatan/tambah', 'Opd\SubKegiatanController@tambah')->name('opd.renstra.sub-kegiatan.tambah');
        Route::post('/opd/renstra/sub-kegiatan/indikator-kinerja/tambah', 'Opd\SubKegiatanController@indikator_kinerja_tambah')->name('opd.renstra.sub-kegiatan.indikator-kinerja.tambah');
        Route::post('/opd/renstra/sub-kegiatan/indikator-kinerja/hapus', 'Opd\SubKegiatanController@indikator_kinerja_hapus')->name('opd.renstra.sub-kegiatan.indikator-kinerja.hapus');
        Route::get('/opd/renstra/sub-kegiatan/indikator-kinerja/edit/{id}', 'Opd\SubKegiatanController@indikator_kinerja_edit');
        Route::post('/opd/renstra/sub-kegiatan/indikator-kinerja/update', 'Opd\SubKegiatanController@indikator_kinerja_update')->name('opd.renstra.sub-kegiatan.indikator-kinerja.update');
        Route::post('/opd/renstra/sub-kegiatan/indikator-kinerja/target-satuan-realisasi/tambah', 'Opd\SubKegiatanController@target_satuan_realisasi_tambah')->name('opd.renstra.sub-kegiatan.indikator-kinerja.target-satuan-realisasi.tambah');
        Route::post('/opd/renstra/sub-kegiatan/indikator-kinerja/target-satuan-realisasi/ubah', 'Opd\SubKegiatanController@target_satuan_realisasi_ubah')->name('opd.renstra.sub-kegiatan.indikator-kinerja.target-satuan-realisasi.ubah');
        Route::post('/opd/renstra/sub-kegiatan/indikator-kinerja/tw/tambah', 'Opd\SubKegiatanController@tw_tambah')->name('opd.renstra.sub-kegiatan.indikator-kinerja.tw.tambah');
        Route::post('/opd/renstra/sub-kegiatan/indikator-kinerja/tw/ubah', 'Opd\SubKegiatanController@tw_ubah')->name('opd.renstra.sub-kegiatan.indikator-kinerja.tw.ubah');
    // Renstra End
    ...
    Route::get('/opd/laporan/tc-23', 'Opd\Laporan\Tc23Controller@tc_23')->name('opd.laporan.tc-23');
    Route::get('/opd/laporan/tc-23/ekspor/pdf', 'Opd\Laporan\Tc23Controller@tc_23_ekspor_pdf')->name('opd.laporan.tc-23.ekspor.pdf');
    Route::get('/opd/laporan/tc-23/ekspor/excel', 'Opd\Laporan\Tc23Controller@tc_23_ekspor_excel')->name('opd.laporan.tc-23.ekspor.excel');
    Route::get('/opd/laporan/tc-24', 'Opd\Laporan\Tc24Controller@tc_24')->name('opd.laporan.tc-24');
    Route::get('/opd/laporan/tc-24/ekspor/pdf', 'Opd\Laporan\Tc24Controller@tc_24_ekspor_pdf')->name('opd.laporan.tc-24.ekspor.pdf');
    Route::get('/opd/laporan/tc-24/ekspor/excel', 'Opd\Laporan\Tc24Controller@tc_24_ekspor_excel')->name('opd.laporan.tc-24.ekspor.excel');
    ...
    Route::get('/opd/laporan/e-80', 'Opd\Laporan\E80Controller@e_80')->name('opd.laporan.e-80');
    Route::get('/opd/laporan/e-80/ekspor/pdf', 'Opd\Laporan\E80Controller@e_80_ekspor_pdf')->name('opd.laporan.e-80.ekspor.pdf');
    Route::get('/opd/laporan/e-80/ekspor/excel', 'Opd\Laporan\E80Controller@e_80_ekspor_excel')->name('opd.laporan.e-80.ekspor.excel');
