...
class TujuanIndikatorImport implements ToCollection,WithStartRow
{
    protected $tujuan_id;

    function __construct($tujuan_id){
        ...
        try {
            ...
            foreach ($rows as $key => $row) {
                if($row->filter()->isNotEmpty())
                {
                    ...
                    $kegiatan_indikator = new PivotTujuanIndikator;
                    $kegiatan_indikator->tujuan_id = $this->tujuan_id;
                    $kegiatan_indikator->indikator = $row[1];
                    $kegiatan_indikator->target = $row[2];
                    $kegiatan_indikator->satuan = $row[3];
