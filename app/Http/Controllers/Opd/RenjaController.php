                                                                                                                                            ...
                                                                                                                                            <table class="table table-striped table-condensed">
                                                                                                                                                ...
                                                                                                                                                foreach ($sasaran_pds as $sasaran_pd){
                                                                                                                                                    $html .= '<tr>';
                                                                                                                                                        ...
                                                                                                                                                        $sasaran_pd_program_rpjmds = SasaranPdProgramRpjmd::where('sasaran_pd_id', $sasaran_pd['id'])->has('program_rpjmd')->get();
                                                                                                                                                        foreach($sasaran_pd_program_rpjmds as $sasaran_pd_program_rpjmd)
                                                                                                                                                        {
                                                                                                                                                            if($sasaran_pd_program_rpjmd->program_rpjmd)
                                                                                                                                                            {
                                                                                                                                                                $cek_perubahan_program = PivotPerubahanProgram::where('program_id', $sasaran_pd_program_rpjmd->program_rpjmd->program->id)->orderBy('tahun_perubahan', 'desc')->latest()->first();
                                                                                                                                                                if($cek_perubahan_program)
                                                                                                                                                                {
                                                                                                                                                                    $html .= '<li>'.$cek_perubahan_program->deskripsi.'</li>';
                                                                                                                                                                } else {
                                                                                                                                                                    ...
                                                                                                                                                                    <table class="table table-striped table-condesed">
                                                                                                                                                                        <thead>
                                                                                                                                                                            <tr>
                                                                                                                                                                                ...
                                                                                                                                                                                <th>Satuan</th>
                                                                                                                                                                                <th>Target Anggaran Renstra</th>
                                                                                                                                                                                <th>Target Anggaran Renja</th>
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            foreach ($tws as $tw) {
                                                                                                                                                                                                                                if($d == 1)
                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if($cek_program_tw_realisasi_renja)
                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            $html .= '<td><input type="number" class="form-control input-program-tw-realisasi-renja-realisasi-rp '.$tw->id.' data-program-target-satuan-rp-realisasi-'.$cek_program_target_satuan_rp_realisasi->id.'"></td>';
                                                                                                                                                                                                                                            $html .= '<td>
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            foreach ($tws as $tw) {
                                                                                                                                                                                                                                if($d == 1)
                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        if($cek_kegiatan_tw_realisasi_renja)
                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            $html .= '<td><input type="number" class="form-control input-kegiatan-tw-realisasi-renja-realisasi-rp '.$tw->id.' data-kegiatan-target-satuan-rp-realisasi-'.$cek_kegiatan_target_satuan_rp_realisasi->id.'"></td>';
                                                                                                                                                                                                                                            $html .= '<td>
                                                                                                                                                    ...
                                                                                                                                                    <table class="table table-condensed table-striped">
                                                                                                                                                        ...
                                                                                                                                                        foreach($kegiatans as $kegiatan)
                                                                                                                                                        {
                                                                                                                                                            $html .= '<tr style="background: #41c0c0">';
                                                                                                                                                                ...
                                                                                                                                                                $html .= '<td width="50%" data-bs-toggle="collapse" data-bs-target="#sub_kegiatan_kegiatan_'.$kegiatan['id'].'" class="accordion-toggle text-white">'.strtoupper($kegiatan['deskripsi']);
                                                                                                                                                                $html .= '<br>';
                                                                                                                                                                if($a == 1 || $a == 2)
                                                                                                                                                                {
                                                                                                                                                                    $html .= '<span class="badge bg-primary text-uppercase renstra-kegiatan-tagging">Visi [Aman]</span>';
                                                                                                                                                                ...
                                                                                                                                                                $html .='</ul></td>';
                                                                                                                                                                $html .= '<td class="text-center"><button type="button" class="btn btn-warning waves-effect waves-light btn-tambah-opd-renja-sub-kegiatan" data-kegiatan-id="'.$kegiatan['id'].'" title="Tambah Sub Kegiatan"><i class="fas fa-plus"></i></button></td>';
                                                                                                                                                            $html .= '</tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <td colspan="4" class="hiddenRow">
