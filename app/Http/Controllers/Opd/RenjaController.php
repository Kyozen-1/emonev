                                                                                                                                                                                        ...
                                                                                                                                                                                        foreach ($tahuns as $tahun) {
                                                                                                                                                                                            ...
                                                                                                                                                                                            if($cek_program_target_satuan_rp_realisasi)
                                                                                                                                                                                            {
                                                                                                                                                                                                if($c == 1)
                                                                                                                                                                                                {
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        $html .= '<td>
                                                                                                                                                                                                                    <button type="button"
                                                                                                                                                                                                                        class="btn btn-icon btn-primary waves-effect waves-light btn-open-tw-realisasi '.$tahun.' data-program-target-satuan-rp-realisasi-'.$cek_program_target_satuan_rp_realisasi->id.'"
                                                                                                                                                                                                                        data-tahun="'.$tahun.'"
