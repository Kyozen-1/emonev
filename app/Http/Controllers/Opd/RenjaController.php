                                                                                                                                                    ...
                                                                                                                                                    <table class="table table-condensed table-striped">
                                                                                                                                                        ...
                                                                                                                                                        foreach($kegiatans as $kegiatan)
                                                                                                                                                        {
                                                                                                                                                            $html .= '<tr>';
                                                                                                                                                                ...
                                                                                                                                                                $html .= '<td width="40%"><table class="table table-bordered">
                                                                                                                                                                    <tbody>';
                                                                                                                                                                        foreach ($kegiatan_indikator_kinerjas as $kegiatan_indikator_kinerja) {
                                                                                                                                                                            $html .= '<tr>';
                                                                                                                                                                                $html .= '<td width="100%">'.$kegiatan_indikator_kinerja->deskripsi;
                                                                                                                                                            ...
                                                                                                                                                            $html .= '<tr style="background: #41c0c0">';
                                                                                                                                                                ...
                                                                                                                                                                $html .= '<td width="40%"><table class="table table-bordered">
                                                                                                                                                                    <tbody>';
                                                                                                                                                                        foreach ($kegiatan_indikator_kinerjas as $kegiatan_indikator_kinerja) {
                                                                                                                                                                            $html .= '<tr>';
                                                                                                                                                                                $html .= '<td width="100%" class="text-white">'.$kegiatan_indikator_kinerja->deskripsi;
                                                                                                                                                                                if($kegiatan_indikator_kinerja->status_indikator == 'Target NSPK')
                                                                                                                                                                                {
                                                                                                                                                                        ...
                                                                                                                                                                        <table class="table table-condensed table-striped">
                                                                                                                                                                            ...
                                                                                                                                                                            foreach ($sub_kegiatans as $sub_kegiatan)
                                                                                                                                                                            {
                                                                                                                                                                                $html .= '<tr>';
                                                                                                                                                                                    ...
                                                                                                                                                                                    <span class="badge bg-warning text-uppercase renstra-kegiatan-tagging">Kegiatan '.$program['kode'].'.'.$kegiatan['kode'].'.'.$sub_kegiatan['kode'].'</span></td>';
