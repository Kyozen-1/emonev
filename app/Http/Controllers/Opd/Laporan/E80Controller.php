...
use Excel;
use PDF;
use App\Exports\OpdE80Ekspor;

class E80Controller extends Controller
{
    public function e_80()
    {
    ...
    public function e_80_ekspor_excel()
    {
        return Excel::download(new OpdE80Ekspor, 'Laporan E-80.xlsx');
    }

    public function e_80_ekspor_pdf()
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $tahun_akhir = $get_periode->tahun_akhir;
