...
use Excel;
use PDF;
use App\Exports\OpdTc23Ekspor;

class Tc23Controller extends Controller
{
    public function tc_23()
    {
    ...
    public function tc_23_ekspor_excel()
    {
        return Excel::download(new OpdTc23Ekspor, 'Laporan TC-23.xlsx');
    }

    public function tc_23_ekspor_pdf()
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $tahun_akhir = $get_periode->tahun_akhir;
