...
class RenstraKegiatanController extends Controller
{
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            foreach ($get_renstra_kegiatans as $get_renstra_kegiatan) {
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                if($cek_perubahan_kegiatan)
                                                                                                                                                                                                                {
                                                                                                                                                                                                                    $kegiatans[] = [
                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                        'target' => $get_renstra_kegiatan->id,
                                                                                                                                                                                                                    ];
                                                                                                                                                                                                                } else {
    ...
    public function detail($id)
    {
        ...
        // Opd
        $get_opds = PivotOpdRentraKegiatan::where('rentra_kegiatan_id', $id)->get();
        $target_rp_pertahun = '';
        foreach ($get_opds as $get_opd) {
    ...
    public function store_target_rp_pertahun(Request $request)
    {
        ...
        // Opd
        $get_opds = PivotOpdRentraKegiatan::where('rentra_kegiatan_id', $request->renstra_kegiatan_id)->get();
        $target_rp_pertahun = '';
        foreach ($get_opds as $get_opd) {
            $target_rp_pertahun .= '<div class="data-table-rows slim">
                                    <h2 class="small-title">OPD: '.$get_opd->opd->nama.' </h2>
