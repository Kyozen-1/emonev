...
{
    public function renja_get_tujuan()
    {
                        ...
                        <table class="table table-condensed table-striped">
                            ...
                            foreach ($visis as $visi)
                            {
                                $html .= '<tr style="background: #bbbbbb;">
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_tujuan_visi'.$visi['id'].'" class="accordion-toggle"></td>
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_tujuan_visi'.$visi['id'].'" class="accordion-toggle text-white">
                                        ...
                                        <tr>
                                            <td colspan="3" class="hiddenRow">
                                                <div class="collapse show" id="renja_tujuan_visi'.$visi['id'].'">
                                                        ...
                                                        <tbody>';
                                                            ...
                                                            foreach ($misis as $misi)
                                                            {
                                                                $html .= '<tr style="background: #c04141;">
                                                                            <td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_tujuan_misi'.$misi['id'].'" class="accordion-toggle text-white">'.$misi['kode'].'</td>
                                                                            <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_tujuan_misi'.$misi['id'].'" class="accordion-toggle text-white">
                                                                        ...
                                                                        <tr>
                                                                            <td colspan="4" class="hiddenRow">
                                                                                <div class="collapse show" id="renja_tujuan_misi'.$misi['id'].'">
                                                                                    <table class="table table-striped table-condesed">
                                                                                        <tbody>';
                                                                                        ...
                                                                                        foreach ($tujuans as $tujuan) {
                                                                                            $html .= '<tr>
                                                                                                        <td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_tujuan_tujuan'.$tujuan['id'].'" class="accordion-toggle">'.$misi['kode'].'.'.$tujuan['kode'].'</td>
                                                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_tujuan_tujuan'.$tujuan['id'].'" class="accordion-toggle">
                                                                                                            '.$tujuan['deskripsi'].'
                                                                                                            <br>';
                                                                                                            if($a == 1 || $a == 2)
                                                                                                            {
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td colspan="4" class="hiddenRow">
                                                                                                            <div class="collapse accordion-body" id="renja_tujuan_tujuan'.$tujuan['id'].'">
                                                                                                                <table class="table table-striped table-condesed">
                                                                                                                    <thead>
                                                                                                                        <tr>
                                                                                                                            <th>OPD</th>
                                                                                                                            ...
                                                                                                                            foreach ($tujuan_pds as $tujuan_pd)
                                                                                                                            {
                                                                                                                                if($b == 1)
                                                                                                                                {
                                                                                                                                    ...
                                                                                                                                    $html .= '<td>
                                                                                                                                        ...
                                                                                                                                        data-bs-target="#renja_tujuan_tujuan_pd_'.$tujuan_pd->id.'"
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td colspan="12" class="hiddenRow">
                                                                                                                                            <div class="collapse accordion-body" id="renja_tujuan_tujuan_pd_'.$tujuan_pd->id.'">
                                                                                                                                                <table class="table table-striped table-condesed">
                                                                                                                                                    <thead>
                                                                                                                                                        <tr>
                                                                                                                                                            <th>Indikator</th>
    ...
    public function renja_get_tujuan_filter(Request $request)
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $jarak_tahun = $get_periode->tahun_akhir - $tahun_awal;
    ...
    public function renja_get_sasaran()
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $jarak_tahun = $get_periode->tahun_akhir - $tahun_awal;
        ...
        $html = '<div class="data-table-rows slim" id="sasaran_div_table">
                    <div class="data-table-responsive-wrapper">
                        <table class="table table-condensed table-striped">
                            ...
                            {
                                $html .= '<tr style="background: #bbbbbb;">
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_sasaran_visi'.$visi['id'].'" class="accordion-toggle"></td>
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_sasaran_visi'.$visi['id'].'" class="accordion-toggle text-white">
                                                '.strtoupper($visi['deskripsi']).'
                                                <br>
                                        ...
                                        <tr>
                                            <td colspan="3" class="hiddenRow">
                                                <div class="collapse show" id="renja_sasaran_visi'.$visi['id'].'">
                                                    <table class="table table-striped table-condensed">
                                                        ...
                                                        {
                                                            $html .= '<tr style="background: #c04141;">
                                                                        <td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_sasaran_misi'.$misi['id'].'" class="accordion-toggle text-white">'.$misi['kode'].'</td>
                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_sasaran_misi'.$misi['id'].'" class="accordion-toggle text-white">
                                                                            '.strtoupper($misi['deskripsi']).'
                                                                            <br>';
                                                                            if($a == 1 || $a == 2)
                                                                            {
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4" class="hiddenRow">
                                                                            <div class="collapse show" id="renja_sasaran_misi'.$misi['id'].'">
                                                                                <table class="table table-striped table-condensed">
                                                                                    <tbody>';
                                                                                    ...
                                                                                    foreach ($tujuans as $tujuan)
                                                                                    {
                                                                                        $html .= '<tr style="background: #41c0c0">
                                                                                                    <td data-bs-toggle="collapse" data-bs-target="#renja_sasaran_tujuan'.$tujuan['id'].'" class="accordion-toggle text-white" width="5%">'.$misi['kode'].'.'.$tujuan['kode'].'</td>
                                                                                                    <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_sasaran_tujuan'.$tujuan['id'].'" class="accordion-toggle text-white">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="4" class="hiddenRow">
                                                                                                        <div class="collapse show" id="renja_sasaran_tujuan'.$tujuan['id'].'">
                                                                                                            <table class="table table-striped table-condensed">
                                                                                                                <tbody>';
                                                                                                                ...
                                                                                                                {
                                                                                                                    $html .= '<tr>
                                                                                                                                <td data-bs-toggle="collapse" data-bs-target="#renja_sasaran_indikator'.$sasaran['id'].'" class="accordion-toggle" width="5%">'.$misi['kode'].'.'.$tujuan['kode'].'.'.$sasaran['kode'].'</td>
                                                                                                                                <td data-bs-toggle="collapse" data-bs-target="#renja_sasaran_indikator'.$sasaran['id'].'" class="accordion-toggle" width="95%">
                                                                                                                                    '.$sasaran['deskripsi'].'
                                                                                                                                    <br>';
                                                                                                                                    if($a == 1 || $a == 2)
                                                                                                                                    {
                                                                                                                            ...
                                                                                                                            <tr>
                                                                                                                                <td colspan="4" class="hiddenRow">
                                                                                                                                    <div class="collapse accordion-body" id="renja_sasaran_indikator'.$sasaran['id'].'">
                                                                                                                                                        ...
                                                                                                                                                        foreach($sasaran_pds as $sasaran_pd)
                                                                                                                                                        {
                                                                                                                                                            if($b == 1)
                                                                                                                                                            {
                                                                                                                                                                ...
                                                                                                                                                                $html .= '<td>
                                                                                                                                                                    ...
                                                                                                                                                                    value="close"
                                                                                                                                                                    data-bs-toggle="collapse"
                                                                                                                                                                    data-bs-target="#renja_sasaran_sasaran_pd_'.$sasaran_pd->id.'"
                                                                                                                                                                    class="accordion-toggle">
                                                                                                                                                                        <i class="fas fa-chevron-right"></i>
                                                                                                                                                                    </button>
                                                                                                                                                                </td>';
                                                                                                                                                                ...
                                                                                                                                                                <tr>
                                                                                                                                                                    <td colspan="12" class="hiddenRow">
                                                                                                                                                                        <div class="collapse accordion-body" id="renja_sasaran_sasaran_pd_'.$sasaran_pd->id.'">
                                                                                                                                                                            <table class="table table-striped table-condesed">
                                                                                                                                                                                <thead>
                                                                                                                                                                                    <tr>
                                                                                                                                                                                        <th>Indikator</th>
    ...
    public function renja_get_sasaran_filter(Request $request)
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $jarak_tahun = $get_periode->tahun_akhir - $tahun_awal;
    ...
    public function renja_get_program()
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $jarak_tahun = $get_periode->tahun_akhir - $tahun_awal;
        ...
        $html = '<div class="data-table-rows slim" id="program_div_table">
                    <div class="data-table-responsive-wrapper">
                        <table class="table table-condensed table-striped">
                            ...
                            {
                                $html .= '<tr style="background: #bbbbbb;">
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_program_visi'.$visi['id'].'" class="accordion-toggle"></td>
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_program_visi'.$visi['id'].'" class="accordion-toggle text-white">
                                                '.strtoupper($visi['deskripsi']).'
                                                <br>
                                        ...
                                        <tr>
                                            <td colspan="3" class="hiddenRow">
                                                <div class="collapse show" id="renja_program_visi'.$visi['id'].'">
                                                    <table class="table table-condensed table-striped">
                                                        <tbody>';
                                                        $get_misis = Misi::where('visi_id', $visi['id'])->get();
                                                        $misis = [];
                                                        ...
                                                        {
                                                            $html .= '<tr style="background: #c04141;">
                                                                        <td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_program_misi'.$misi['id'].'" class="accordion-toggle text-white">'.$misi['kode'].'</td>
                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_program_misi'.$misi['id'].'" class="accordion-toggle text-white">
                                                                            '.strtoupper($misi['deskripsi']).'
                                                                            <br>';
                                                                            if($a == 1 || $a == 2)
                                                                            {
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4" class="hiddenRow">
                                                                            <div class="collapse show" id="renja_program_misi'.$misi['id'].'">
                                                                                <table class="table table-condensed table-striped">
                                                                                    <tbody>';
                                                                                        $get_tujuans = Tujuan::where('misi_id', $misi['id'])->get();
                                                                                        $tujuans = [];
                                                                                        ...
                                                                                        {
                                                                                            $html .= '<tr style="background: #41c0c0">
                                                                                                        <td data-bs-toggle="collapse" data-bs-target="#renja_program_tujuan'.$tujuan['id'].'" class="accordion-toggle text-white" width="5%">'.$misi['kode'].'.'.$tujuan['kode'].'</td>
                                                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_program_tujuan'.$tujuan['id'].'" class="accordion-toggle text-white">
                                                                                                            '.strtoupper($tujuan['deskripsi']).'
                                                                                                            <br>';
                                                                                                            if($a == 1 || $a == 2)
                                                                                                            {
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td colspan="4" class="hiddenRow">
                                                                                                            <div class="collapse show" id="renja_program_tujuan'.$tujuan['id'].'">
                                                                                                                <table class="table table-condensed table-striped">
                                                                                                                    <tbody>';
                                                                                                                        $get_sasarans = Sasaran::where('tujuan_id', $tujuan['id'])->get();
                                                                                                                        $sasarans = [];
                                                                                                                        ...
                                                                                                                        foreach ($sasarans as $sasaran)
                                                                                                                        {
                                                                                                                            $html .= '<tr style="background:#41c081">
                                                                                                                                        <td data-bs-toggle="collapse" data-bs-target="#renja_program_sasaran_'.$sasaran['id'].'" class="accordion-toggle text-white" width="5%">'.$misi['kode'].'.'.$tujuan['kode'].'.'.$sasaran['kode'].'</td>
                                                                                                                                        <td data-bs-toggle="collapse" data-bs-target="#renja_program_sasaran_'.$sasaran['id'].'" class="accordion-toggle text-white" width="95%">
                                                                                                                                    ...
                                                                                                                                    <tr>
                                                                                                                                        <td colspan="4" class="hiddenRow">
                                                                                                                                            <div class="collapse show" id="renja_program_sasaran_'.$sasaran['id'].'">
                                                                                                                                                <table class="table table-condensed table-striped">
                                                                                                                                                    <tbody>';
                                                                                                                                                        ...
                                                                                                                                                        {
                                                                                                                                                            $html .= '<tr>';
                                                                                                                                                                $html .= '<td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_program_program_'.$program['id'].'" class="accordion-toggle">'.$program['kode'].'</td>';
                                                                                                                                                                $html .= '<td width="45%" data-bs-toggle="collapse" data-bs-target="#renja_program_program_'.$program['id'].'" class="accordion-toggle">'.$program['deskripsi'];
                                                                                                                                                                ...
                                                                                                                                                                $html .= '<td width="50%" data-bs-toggle="collapse" data-bs-target="#renja_program_program_'.$program['id'].'" class="accordion-toggle"><ul>';
                                                                                                                                                            ...
                                                                                                                                                            <tr>
                                                                                                                                                                <td colspan="4" class="hiddenRow">
                                                                                                                                                                    <div class="collapse accordion-body" id="renja_program_program_'.$program['id'].'">
                                                                                                                                                                        <table class="table table-striped table-condesed">
                                                                                                                                                                            <thead>
                                                                                                                                                                                <tr>
                                                                                                                                                                                    <th>No</th>
                                                                                                                                                                            ...
                                                                                                                                                                            foreach ($program_indikator_kinerjas as $program_indikator_kinerja) {
                                                                                                                                                                                $html .= '<tr>';
                                                                                                                                                                                    ...
                                                                                                                                                                                    $html .= '<td>
                                                                                                                                                                                                ...
                                                                                                                                                                                                value="close"
                                                                                                                                                                                                data-bs-toggle="collapse"
                                                                                                                                                                                                data-bs-target="#renja_program_program_indikator-kinerja_'.$program_indikator_kinerja->id.'"
                                                                                                                                                                                                class="accordion-toggle">
                                                                                                                                                                                                    <i class="fas fa-chevron-right"></i>
                                                                                                                                                                                                </button>
                                                                                                                                                                                            </td>';
                                                                                                                                                                                ...
                                                                                                                                                                                <tr>
                                                                                                                                                                                    <td colspan="12" class="hiddenRow">
                                                                                                                                                                                        <div class="collapse accordion-body" id="renja_program_program_indikator-kinerja_'.$program_indikator_kinerja->id.'">
                                                                                                                                                                                            <table class="table table-striped table-condesed">
                                                                                                                                                                                                <thead>
                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                        <th>OPD</th>
    ...
    public function renja_get_program_filter(Request $request)
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $jarak_tahun = $get_periode->tahun_akhir - $tahun_awal;
                                                        ...
                                                        foreach ($misis as $misi)
                                                        {
                                                            $html .= '<tr style="background: #c04141;">
                                                                        ...
                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_program_misi'.$misi['id'].'" class="accordion-toggle text-white">
                                                                            '.strtoupper($misi['deskripsi']).'
                                                                            <br>';
                                                                            $html .= '<span class="badge bg-primary text-uppercase renstra-program-tagging">Visi '.$request->visi.'</span>';
                                                                            $html .= ' <span class="badge bg-warning text-uppercase renstra-program-tagging">Misi '.$misi['kode'].'</span>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
    ...
    public function renja_get_kegiatan()
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $jarak_tahun = $get_periode->tahun_akhir - $tahun_awal;
        ...
        $html = '<div class="data-table-rows slim" id="program_div_table">
                    <div class="data-table-responsive-wrapper">
                        <table class="table table-condensed table-striped">
                            ...
                            {
                                $html .= '<tr style="background: #bbbbbb;">
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_visi'.$visi['id'].'" class="accordion-toggle"></td>
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_visi'.$visi['id'].'" class="accordion-toggle text-white">
                                                '.strtoupper($visi['deskripsi']).'
                                                <br>
                                        ...
                                        <tr>
                                            <td colspan="3" class="hiddenRow">
                                                <div class="collapse show" id="renja_kegiatan_visi'.$visi['id'].'">
                                                    <table class="table table-condensed table-striped">
                                                        <tbody>';
                                                        $get_misis = Misi::where('visi_id', $visi['id'])->get();
                                                        $misis = [];
                                                        ...
                                                        {
                                                            $html .= '<tr style="background: #c04141;">
                                                                        <td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_misi'.$misi['id'].'" class="accordion-toggle text-white">'.$misi['kode'].'</td>
                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_misi'.$misi['id'].'" class="accordion-toggle text-white">
                                                                            '.strtoupper($misi['deskripsi']).'
                                                                            <br>';
                                                                            if($a == 1 || $a == 2)
                                                                            {
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4" class="hiddenRow">
                                                                            <div class="collapse show" id="renja_kegiatan_misi'.$misi['id'].'">
                                                                                <table class="table table-condensed table-striped">
                                                                                    <tbody>';
                                                                                        $get_tujuans = Tujuan::where('misi_id', $misi['id'])->get();
                                                                                        $tujuans = [];
                                                                                        ...
                                                                                        {
                                                                                            $html .= '<tr style="background: #41c0c0">
                                                                                                        <td data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_tujuan'.$tujuan['id'].'" class="accordion-toggle text-white" width="5%">'.$misi['kode'].'.'.$tujuan['kode'].'</td>
                                                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_tujuan'.$tujuan['id'].'" class="accordion-toggle text-white">
                                                                                                            '.$tujuan['deskripsi'].'
                                                                                                            <br>';
                                                                                                            if($a == 1 || $a == 2)
                                                                                                            {
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td colspan="4" class="hiddenRow">
                                                                                                            <div class="collapse show" id="renja_kegiatan_tujuan'.$tujuan['id'].'">
                                                                                                                <table class="table table-condensed table-striped">
                                                                                                                    <tbody>';
                                                                                                                    $get_sasarans = Sasaran::where('tujuan_id', $tujuan['id'])->get();
                                                                                                                    $sasarans = [];
                                                                                                                    ...
                                                                                                                    {
                                                                                                                        $html .= '<tr style="background:#41c081">
                                                                                                                                    <td data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_sasaran_'.$sasaran['id'].'" class="accordion-toggle text-white" width="5%">'.$misi['kode'].'.'.$tujuan['kode'].'.'.$sasaran['kode'].'</td>
                                                                                                                                    <td data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_sasaran_'.$sasaran['id'].'" class="accordion-toggle text-white" width="45%">
                                                                                                                                        '.strtoupper($sasaran['deskripsi']).'
                                                                                                                                        <br>';
                                                                                                                                        if($a == 1 || $a == 2)
                                                                                                                                        {
                                                                                                                                    ...
                                                                                                                                    $html .= '<td width="30%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_sasaran_'.$sasaran['id'].'" class="accordion-toggle"><ul>';
                                                                                                                                    ...
                                                                                                                                    $html .= '<td data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_sasaran_'.$sasaran['id'].'" class="accordion-toggle" width="20%"></td>
                                                                                                                                </tr>
                                                                                                                                <tr>
                                                                                                                                    <td colspan="4" class="hiddenRow">
                                                                                                                                        <div class="collapse show" id="renja_kegiatan_sasaran_'.$sasaran['id'].'">
                                                                                                                                            <table class="table table-condensed table-striped">
                                                                                                                                                <tbody>';
                                                                                                                                                $get_programs = Program::whereHas('program_rpjmd', function($q) use ($sasaran){
                                                                                                                                                    $q->whereHas('pivot_sasaran_indikator_program_rpjmd', function($q) use ($sasaran) {
                                                                                                                                                ...
                                                                                                                                                foreach($programs as $program)
                                                                                                                                                {
                                                                                                                                                    ...
                                                                                                                                                    $html .= '<td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_program_'.$program['id'].'" class="accordion-toggle text-white">'.$program['kode'].'</td>';
                                                                                                                                                        $html .= '<td width="45%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_program_'.$program['id'].'" class="accordion-toggle text-white">'.strtoupper($program['deskripsi']);
                                                                                                                                                        $cek_program_rjmd = ProgramRpjmd::where('program_id', $program['id'])->where('status_program', 'Prioritas')->first();
                                                                                                                                                        if($cek_program_rjmd)
                                                                                                                                                        {
                                                                                                                                                            $html .= '<i class="fas fa-star text-primary" title="Program Prioritas"> </i>';
                                                                                                                                                        ...
                                                                                                                                                        $html .= '<td width="30%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_program_'.$program['id'].'" class="accordion-toggle"><ul>';
                                                                                                                                                            $program_indikator_kinerjas = ProgramIndikatorKinerja::where('program_id', $program['id'])->get();
                                                                                                                                                            foreach($program_indikator_kinerjas as $program_indikator_kinerja)
                                                                                                                                                            {
                                                                                                                                                        ...
                                                                                                                                                        $html .= '</ul></td>';
                                                                                                                                                        $html .= '<td width="20%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_program_'.$program['id'].'" class="accordion-toggle"></td>';
                                                                                                                                                    $html .= '</tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <td colspan="4" class="hiddenRow">
                                                                                                                                                                    <div class="collapse show" id="renja_kegiatan_program_'.$program['id'].'">
                                                                                                                                                                        <table class="table table-condensed table-striped">
                                                                                                                                                                            ...
                                                                                                                                                                            {
                                                                                                                                                                                $html .= '<tr>';
                                                                                                                                                                                    $html .= '<td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_kegiatan_'.$kegiatan['id'].'" class="accordion-toggle">'.$program['kode'].'.'.$kegiatan['kode'].'</td>';
                                                                                                                                                                                    $html .= '<td width="45%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_kegiatan_'.$kegiatan['id'].'" class="accordion-toggle">'.strtoupper($kegiatan['deskripsi']);
                                                                                                                                                                                    $html .= '<br>';
                                                                                                                                                                                    if($a == 1 || $a == 2)
                                                                                                                                                                                    {
                                                                                                                                                                                        $html .= '<span class="badge bg-primary text-uppercase renstra-kegiatan-tagging">Visi [Aman]</span>';
                                                                                                                                                                                    ...
                                                                                                                                                                                    $html .= '<td width="30%" data-bs-toggle="collapse" data-bs-target="#renja_kegiatan_kegiatan_'.$kegiatan['id'].'" class="accordion-toggle"><ul>';
                                                                                                                                                                                ...
                                                                                                                                                                                <tr>
                                                                                                                                                                                    <td colspan="4" class="hiddenRow">
                                                                                                                                                                                        <div class="collapse accordion-body" id="renja_kegiatan_kegiatan_'.$kegiatan['id'].'">
                                                                                                                                                                                            <table class="table table-condensed table-striped">
                                                                                                                                                                                                <thead>
                                                                                                                                                                                                    <tr>
                                                                                                                                                                                                        <th>No</th>
    ...
    public function renja_get_kegiatan_filter(Request $request)
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $jarak_tahun = $get_periode->tahun_akhir - $tahun_awal;
    ...
    public function renja_get_sub_kegiatan()
    {
        $get_periode = TahunPeriode::where('status', 'Aktif')->latest()->first();
        $tahun_awal = $get_periode->tahun_awal;
        $jarak_tahun = $get_periode->tahun_akhir - $tahun_awal;
        ...
        $html = '<div class="data-table-rows slim" id="program_div_table">
                    <div class="data-table-responsive-wrapper">
                        <table class="table table-condensed table-striped">
                            ...
                            {
                                $html .= '<tr style="background: #bbbbbb;">
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_visi'.$visi['id'].'" class="accordion-toggle"></td>
                                            <td data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_visi'.$visi['id'].'" class="accordion-toggle text-white">
                                                '.strtoupper($visi['deskripsi']).'
                                                <br>
                                                <span class="badge bg-primary text-uppercase renstra-kegiatan-tagging">Visi</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td colspan="3" class="hiddenRow">
                                                <div class="collapse show" id="renja_sub_kegiatan_visi'.$visi['id'].'">
                                                    <table class="table table-condensed table-striped">
                                                        <tbody>';
                                                        $get_misis = Misi::where('visi_id', $visi['id'])->get();
                                                        $misis = [];
                                                        ...
                                                        {
                                                            $html .= '<tr style="background: #c04141;">
                                                                        <td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_misi'.$misi['id'].'" class="accordion-toggle text-white">'.$misi['kode'].'</td>
                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_misi'.$misi['id'].'" class="accordion-toggle text-white">
                                                                            '.strtoupper($misi['deskripsi']).'
                                                                            <br>';
                                                                            if($a == 1 || $a == 2)
                                                                            {
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="4" class="hiddenRow">
                                                                            <div class="collapse show" id="renja_sub_kegiatan_misi'.$misi['id'].'">
                                                                                <table class="table table-condensed table-striped">
                                                                                    <tbody>';
                                                                                        $get_tujuans = Tujuan::where('misi_id', $misi['id'])->get();
                                                                                        $tujuans = [];
                                                                                        ...
                                                                                        {
                                                                                            $html .= '<tr style="background: #41c0c0">
                                                                                                        <td data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_tujuan'.$tujuan['id'].'" class="accordion-toggle text-white" width="5%">'.$misi['kode'].'.'.$tujuan['kode'].'</td>
                                                                                                        <td width="95%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_tujuan'.$tujuan['id'].'" class="accordion-toggle text-white">
                                                                                                            '.$tujuan['deskripsi'].'
                                                                                                            <br>';
                                                                                                            if($a == 1 || $a == 2)
                                                                                                            {
                                                                                                    ...
                                                                                                    <tr>
                                                                                                        <td colspan="4" class="hiddenRow">
                                                                                                            <div class="collapse show" id="renja_sub_kegiatan_tujuan'.$tujuan['id'].'">
                                                                                                                <table class="table table-condensed table-striped">
                                                                                                                    <tbody>';
                                                                                                                    $get_sasarans = Sasaran::where('tujuan_id', $tujuan['id'])->get();
                                                                                                                    $sasarans = [];
                                                                                                                    ...
                                                                                                                    {
                                                                                                                        $html .= '<tr style="background:#41c081">
                                                                                                                                    <td data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_sasaran_'.$sasaran['id'].'" class="accordion-toggle text-white" width="5%">'.$misi['kode'].'.'.$tujuan['kode'].'.'.$sasaran['kode'].'</td>
                                                                                                                                    <td data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_sasaran_'.$sasaran['id'].'" class="accordion-toggle text-white" width="45%">
                                                                                                                                        '.strtoupper($sasaran['deskripsi']).'
                                                                                                                                        <br>';
                                                                                                                                        if($a == 1 || $a == 2)
                                                                                                                                        {
                                                                                                                                    ...
                                                                                                                                    $sasaran_indikator_kinerjas = SasaranIndikatorKinerja::where('sasaran_id', $sasaran['id'])->get();
                                                                                                                                    $html .= '<td width="30%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_sasaran_'.$sasaran['id'].'" class="accordion-toggle"><ul>';
                                                                                                                                        foreach($sasaran_indikator_kinerjas as $sasaran_indikator_kinerja)
                                                                                                                                        {
                                                                                                                                            $html .= '<li class="mb-2 text-white">'.strtoupper($sasaran_indikator_kinerja->deskripsi).'</li>';
                                                                                                                                        }
                                                                                                                                    ...
                                                                                                                                    $html .= '<td data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_sasaran_'.$sasaran['id'].'" class="accordion-toggle" width="20%"></td>
                                                                                                                                </tr>
                                                                                                                                <tr>
                                                                                                                                    <td colspan="4" class="hiddenRow">
                                                                                                                                        <div class="collapse show" id="renja_sub_kegiatan_sasaran_'.$sasaran['id'].'">
                                                                                                                                            <table class="table table-condensed table-striped">
                                                                                                                                                <tbody>';
                                                                                                                                                $get_programs = Program::whereHas('program_rpjmd', function($q) use ($sasaran){
                                                                                                                                                    $q->whereHas('pivot_sasaran_indikator_program_rpjmd', function($q) use ($sasaran) {
                                                                                                                                                ...
                                                                                                                                                {
                                                                                                                                                    $html .= '<tr style="background:#bbae7f;">';
                                                                                                                                                    $html .= '<td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_program_'.$program['id'].'" class="accordion-toggle text-white">'.$program['kode'].'</td>';
                                                                                                                                                        $html .= '<td width="45%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_program_'.$program['id'].'" class="accordion-toggle text-white">'.strtoupper($program['deskripsi']);
                                                                                                                                                        $cek_program_rjmd = ProgramRpjmd::where('program_id', $program['id'])->where('status_program', 'Prioritas')->first();
                                                                                                                                                        if($cek_program_rjmd)
                                                                                                                                                        {
                                                                                                                                                            $html .= '<i class="fas fa-star text-primary" title="Program Prioritas"> </i>';
                                                                                                                                                        ...
                                                                                                                                                        <span class="badge bg-danger text-uppercase renstra-kegiatan-tagging">Sasaran '.$misi['kode'].'.'.$tujuan['kode'].'.'.$sasaran['kode'].'</span>
                                                                                                                                                        <span class="badge bg-dark text-uppercase renstra-kegiatan-tagging">Program '.$program['kode'].'</span></td>';
                                                                                                                                                        $html .= '<td width="30%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_program_'.$program['id'].'" class="accordion-toggle"><ul>';
                                                                                                                                                            $program_indikator_kinerjas = ProgramIndikatorKinerja::where('program_id', $program['id'])->get();
                                                                                                                                                            foreach($program_indikator_kinerjas as $program_indikator_kinerja)
                                                                                                                                                            {
                                                                                                                                                                $html .= '<li class="text-white">'.strtoupper($program_indikator_kinerja->deskripsi).'</li>';
                                                                                                                                                        ...
                                                                                                                                                        $html .= '</ul></td>';
                                                                                                                                                        $html .= '<td width="20%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_program_'.$program['id'].'" class="accordion-toggle"></td>';
                                                                                                                                                    $html .= '</tr>
                                                                                                                                                            <tr>
                                                                                                                                                                <td colspan="4" class="hiddenRow">
                                                                                                                                                                    <div class="collapse show" id="renja_sub_kegiatan_program_'.$program['id'].'">
                                                                                                                                                                        <table class="table table-condensed table-striped">
                                                                                                                                                                            <tbody>';
                                                                                                                                                                            $get_kegiatans = Kegiatan::where('program_id', $program['id'])->get();
                                                                                                                                                                            $kegiatans = [];
                                                                                                                                                                            ...
                                                                                                                                                                            foreach($kegiatans as $kegiatan)
                                                                                                                                                                            {
                                                                                                                                                                                $html .= '<tr style="background:#7f8cbb">';
                                                                                                                                                                                    $html .= '<td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_kegiatan_'.$kegiatan['id'].'" class="accordion-toggle text-white">'.$program['kode'].'.'.$kegiatan['kode'].'</td>';
                                                                                                                                                                                    $html .= '<td width="45%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_kegiatan_'.$kegiatan['id'].'" class="accordion-toggle text-white">'.strtoupper($kegiatan['deskripsi']);
                                                                                                                                                                                    $html .= '<br>';
                                                                                                                                                                                    if($a == 1 || $a == 2)
                                                                                                                                                                                    {
                                                                                                                                                                                        $html .= '<span class="badge bg-primary text-uppercase renstra-kegiatan-tagging">Visi [Aman]</span>';
                                                                                                                                                                                    ...
                                                                                                                                                                                    <span class="badge bg-dark text-uppercase renstra-kegiatan-tagging">Program '.$program['kode'].'</span>
                                                                                                                                                                                    <span class="badge bg-success text-uppercase renstra-kegiatan-tagging">Kegiatan '.$program['kode'].'.'.$kegiatan['kode'].'</span></td>';
                                                                                                                                                                                    $html .= '<td width="30%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_kegiatan_'.$kegiatan['id'].'" class="accordion-toggle"><ul>';
                                                                                                                                                                                    $kegiatan_indikator_kinerjas = KegiatanIndikatorKinerja::where('kegiatan_id', $kegiatan['id'])->get();
                                                                                                                                                                                    foreach($kegiatan_indikator_kinerjas as $kegiatan_indikator_kinerja)
                                                                                                                                                                                    {
                                                                                                                                                                                        $html .= '<li class="mb-2 text-white">'.$kegiatan_indikator_kinerja->deskripsi.'</li>';
                                                                                                                                                                                    }
                                                                                                                                                                                    $html .= '</ul></td>';
                                                                                                                                                                                    $html .= '<td width="20%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_kegiatan_'.$kegiatan['id'].'" class="accordion-toggle"></td>';
                                                                                                                                                                                $html .= '</tr>
                                                                                                                                                                                        <tr>
                                                                                                                                                                                            <td colspan="4" class="hiddenRow">
                                                                                                                                                                                                <div class="collapse accordion-body show" id="renja_sub_kegiatan_kegiatan_'.$kegiatan['id'].'">
                                                                                                                                                                                                    <table class="table table-condensed table-striped">
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        foreach ($sub_kegiatans as $sub_kegiatan) {
                                                                                                                                                                                                            $html .= '<tr>';
                                                                                                                                                                                                                $html .= '<td width="5%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_sub_kegiatan_'.$sub_kegiatan['id'].'" class="accordion-toggle">'.$sub_kegiatan['kode'].'</td>';
                                                                                                                                                                                                                $html .= '<td width="45%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_sub_kegiatan_'.$sub_kegiatan['id'].'" class="accordion-toggle">'.$sub_kegiatan['deskripsi'];
                                                                                                                                                                                                                $html .= '<br>';
                                                                                                                                                                                                                if($a == 1 || $a == 2)
                                                                                                                                                                                                                {
                                                                                                                                                                                                                    $html .= '<span class="badge bg-primary text-uppercase renstra-kegiatan-tagging">Visi [Aman]</span>';
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                $html .= '<td width="30%" data-bs-toggle="collapse" data-bs-target="#renja_sub_kegiatan_sub_kegiatan_'.$sub_kegiatan['id'].'" class="accordion-toggle"><ul>';
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            <tr>
                                                                                                                                                                                                                <td colspan="4" class="hiddenRow">
                                                                                                                                                                                                                    <div class="collapse accordion-body" id="renja_sub_kegiatan_sub_kegiatan_'.$sub_kegiatan['id'].'">
                                                                                                                                                                                                                        <table class="table table-condensed table-striped">
                                                                                                                                                                                                                            <thead>
                                                                                                                                                                                                                                <tr>
                                                                                                                                                                                                                                    <th>No</th>
                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                            foreach($sub_kegiatan_indikator_kinerjas as $sub_kegiatan_indikator_kinerja)
                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                $html .= '<tr>';
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    $html .= '<td>
                                                                                                                                                                                                                                                <button type="button"
                                                                                                                                                                                                                                                class="btn btn-icon btn-primary waves-effect waves-light btn-open-sub-kegiatan-indikator-kinerja data-sub-kegiatan-indikator-kinerja-'.$sub_kegiatan_indikator_kinerja->id.'"
                                                                                                                                                                                                                                                data-sub-kegiatan-indikator-kinerja-id="'.$sub_kegiatan_indikator_kinerja->id.'"
                                                                                                                                                                                                                                                value="close"
                                                                                                                                                                                                                                                data-bs-toggle="collapse"
                                                                                                                                                                                                                                                data-bs-target="#sub_kegiatan_sub_kegiatan_indikator_kinerja_'.$sub_kegiatan_indikator_kinerja->id.'"
                                                                                                                                                                                                                                                class="accordion-toggle">
                                                                                                                                                                                                                                                    <i class="fas fa-chevron-right"></i>
                                                                                                                                                                                                                                                </button>
                                                                                                                                                                                                                                            </td>';
                                                                                                                                                                                                                                $html .= '</tr>
                                                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                                                            <td colspan="12" class="hiddenRow">
                                                                                                                                                                                                                                                <div class="collapse accordion-body" id="sub_kegiatan_sub_kegiatan_indikator_kinerja_'.$sub_kegiatan_indikator_kinerja->id.'">
                                                                                                                                                                                                                                                    <table class="table table-bordered">
                                                                                                                                                                                                                                                        <thead>
                                                                                                                                                                                                                                                            <tr>
                                                                                                                                                                                                                                                                <th>OPD</th>
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                            $html .= '<tr>';
                                                                                                                                                                                                                                                                $master_opd = MasterOpd::find($opd_sub_kegiatan_indikator_kinerja->opd_id);
                                                                                                                                                                                                                                                                if($master_opd)
                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                    $html .= '<td>'.$master_opd->nama.'</td>';
                                                                                                                                                                                                                                                                } else {
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                foreach($tahuns as $tahun)
                                                                                                                                                                                                                                                                {
                                                                                                                                                                                                                                                                    if($b == 1)
                                                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                                                            $cek_sub_kegiatan_target_satuan_rp_realisasi = SubKegiatanTargetSatuanRpRealisasi::where('opd_sub_kegiatan_indikator_kinerja_id', $opd_sub_kegiatan_indikator_kinerja->id)->where('tahun', $tahun)->first();
                                                                                                                                                                                                                                                                            if($cek_sub_kegiatan_target_satuan_rp_realisasi)
                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                    $html .= '<td>'.$cek_sub_kegiatan_target_satuan_rp_realisasi->target.'/'.$sub_kegiatan_indikator_kinerja->satuan.'</td>';
                                                                                                                                                                                                                                                                                    $html .= '<td>Rp.'.number_format($cek_sub_kegiatan_target_satuan_rp_realisasi->target_anggaran_awal, 2, ',', '.').'</td>';
                                                                                                                                                                                                                                                                                    $html .= '<td>Rp.'.number_format($cek_sub_kegiatan_target_satuan_rp_realisasi->target_anggaran_perubahan, 2, ',', '.').'</td>';
                                                                                                                                                                                                                                                                                    $html .= '<td>'.$tahun.'</td>';
                                                                                                                                                                                                                                                                                    $html .= '<td>
                                                                                                                                                                                                                                                                                                <button type="button"
                                                                                                                                                                                                                                                                                                class="btn btn-icon btn-primary waves-effect waves-light btn-open-sub-kegiatan-target-satuan-rp-realisasi data-sub-kegiatan-target-satuan-rp-realisasi-'.$cek_sub_kegiatan_target_satuan_rp_realisasi->id.'"
                                                                                                                                                                                                                                                                                                data-sub-kegiatan-target-satuan-rp-realisasi-id="'.$cek_sub_kegiatan_target_satuan_rp_realisasi->id.'"
                                                                                                                                                                                                                                                                                                value="close"
                                                                                                                                                                                                                                                                                                data-bs-toggle="collapse"
                                                                                                                                                                                                                                                                                                data-bs-target="#sub_kegiatan_sub_kegiatan_target_satuan_rp_realisasi_'.$cek_sub_kegiatan_target_satuan_rp_realisasi->id.'"
                                                                                                                                                                                                                                                                                                class="accordion-toggle">
                                                                                                                                                                                                                                                                                                    <i class="fas fa-chevron-right"></i>
                                                                                                                                                                                                                                                                                                </button>
                                                                                                                                                                                                                                                                                            </td>';
                                                                                                                                                                                                                                                                                $html .= '</tr>
                                                                                                                                                                                                                                                                                        <tr>
                                                                                                                                                                                                                                                                                            <td colspan="12" class="hiddenRow">
                                                                                                                                                                                                                                                                                                <div class="collapse accordion-body" id="sub_kegiatan_sub_kegiatan_target_satuan_rp_realisasi_'.$cek_sub_kegiatan_target_satuan_rp_realisasi->id.'">
                                                                                                                                                                                                                                                                                                    <table class="table table-bordered">
                                                                                                                                                                                                                                                                                                        <thead>
                                                                                                                                                                                                                                                                                                            <tr>
                                                                                                                                                                                                                                                                                                                <th>Target Kinerja</th>
                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                        foreach($tws as $tw)
                                                                                                                                                                                                                                                                                                        {
                                                                                                                                                                                                                                                                                                            if($c == 1)
                                                                                                                                                                                                                                                                                                            {
                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                    {
                                                                                                                                                                                                                                                                                                                        $html .= '<td>'.$cek_sub_kegiatan_tw_realisasi->realisasi.'/'.$sub_kegiatan_indikator_kinerja->satuan.'</td>';
                                                                                                                                                                                                                                                                                                                        $html .= '<td>Rp.'.number_format($cek_sub_kegiatan_tw_realisasi->realisasi_rp, 2, ',', '.').'</td>';
                                                                                                                                                                                                                                                                                                                    } else {
                                                                                                                                                                                                                                                                                                                        $html .= '<td></td>';
                                                                                                                                                                                                                                                                                                                        $html .= '<td></td>';
                                                                                                                                                                                                                                                                                                                    }
