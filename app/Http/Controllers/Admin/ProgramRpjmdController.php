...
class ProgramRpjmdController extends Controller
{
    ...
    {
        $sasaran_indikator_kinerjas = SasaranIndikatorKinerja::where('sasaran_id', $request->id)->get();
        return response()->json($sasaran_indikator_kinerjas);
    }
    ...
    public function store(Request $request)
    {
        $errors = Validator::make($request->all(), [
            ...
            'program_sasaran_indikator_id' => 'required | array'
        ]);
        ...
        for ($i=0; $i < count($sasaran_indikator_id); $i++) {
            ...
            $pivot_sasaran_indikator_program_rpjmd->sasaran_indikator_kinerja_id = $sasaran_indikator_id[$i];
    ...
    public function pivot_sasaran_indikator_program_rpjmd_delete(Request $request)
    {
        $errors = Validator::make($request->all(), [
            'pivot_sasaran_indikator_program_rpjmd_id' => 'required',
        ...
        PivotSasaranIndikatorProgramRpjmd::find($request->pivot_sasaran_indikator_program_rpjmd_id)->delete();

        $cek_program_rpjmd = PivotSasaranIndikatorProgramRpjmd::where('program_rpjmd_id', $request->program_rpjmd_id)->first();
