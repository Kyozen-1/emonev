...
use Excel;
use PDF;
use App\Exports\Tc27Ekspor;

class Tc27Controller extends Controller
{
    public function tc_27(Request $request)
    {
    ...
    public function tc_27_ekspor_pdf($opd_id)
    {
    ...
    public function tc_27_ekspor_excel($opd_id)
    {
        return Excel::download(new Tc27Ekspor($opd_id), 'Laporan TC-27.xlsx');
    }
}
