...
use Excel;
use PDF;
use App\Exports\Tc24Ekspor;

class Tc24Controller extends Controller
{
    public function tc_24(Request $request)
    {
    ...
    public function tc_24_ekspor_pdf($opd_id)
    {
        $tc_24 = '';
    ...
    public function tc_24_ekspor_excel($opd_id)
    {
        return Excel::download(new Tc24Ekspor($opd_id), 'Laporan TC-24.xlsx');
    }
}
