                                            ...
                                            <table class="table table-striped table-condesed">
                                                ...
                                                foreach ($misis as $misi) {
                                                    $html .= '<tr style="background: #c04141;">
                                                        ...
                                                        <td width="20%">
                                                            <button class="btn btn-primary waves-effect waves-light mr-2 tujuan_create" type="button" data-bs-toggle="modal" data-bs-target="#addEditTujuanModal" title="Tambah Data Tujuan" data-misi-id="'.$misi['id'].'"><i class="fas fa-plus"></i></button>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4" class="hiddenRow">
                                                            <div class="collapse show" id="tujuan_misi'.$misi['id'].'">
                                                                <table class="table table-striped table-condesed">
                                                                    <tbody id="tbodyTujuanMisiTujuan'.$misi['id'].'">';
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td colspan="4" class="hiddenRow">
                                                                                                        <div class="collapse show" id="sasaran_tujuan'.$tujuan['id'].'">
                                                                                                            <table class="table table-striped table-condensed">
                                                                                                                <tbody id="tbodySasaranTujuanSasaran'.$tujuan['id'].'">';
