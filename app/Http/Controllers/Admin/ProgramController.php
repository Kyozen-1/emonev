...
class ProgramController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        {
            $getUrusan = Urusan::find($request->program_urusan_id);
            $urusan = [
                'id' => $getUrusan->id,
                'kode' => $getUrusan->kode,
                                                        ...
                                                        <tbody>';
                                                            foreach ($program_indikator_kinerjas as $program_indikator_kinerja) {
                                                                $html .= '<tr>';
                                                                    ...
                                                                    $html .='</td>';
                                                                    $html .= '<td width="25%">
                                                                        <button class="btn btn-sm btn-icon btn-icon-only btn-outline-warning btn-edit-program-indikator-kinerja mr-1" data-id="'.$program_indikator_kinerja->id.'" data-program-id="'.$program['id'].'" title="Edit Indikator Kinerja Program"><i class="fas fa-edit"></i></button>
                                                                        <button class="btn btn-sm btn-icon btn-icon-only btn-outline-warning btn-edit-opd-program-indikator-kinerja mr-1" data-id="'.$program_indikator_kinerja->id.'" data-program-id="'.$program['id'].'" title="Edit OPD"><i class="fas fa-user"></i></button>
                                                    ...
                                                    <td colspan="4" class="hiddenRow">
                                                        <div class="collapse accordion-body" id="program_program'.$program['id'].'">
                                                            <table class="table table-striped table-condesed">
                                                                ...
                                                                <tbody id="tbodyProgramIndikatorKinerja'.$program['id'].'">';
                                                                $program_indikator_kinerjas = ProgramIndikatorKinerja::where('program_id', $program['id'])->get();
    ...
    public function update(Request $request)
    {
        ...
        if($request->nav_nomenklatur_program_tahun == 'semua')
        {
            ...
            $getProgram = Program::find($request->program_hidden_id);
            $program = [
                'id' => $getProgram->id,
                'kode' => $getProgram->kode,
                'deskripsi' => $getProgram->deskripsi
            ];
            $html = '<td data-bs-toggle="collapse" data-bs-target="#program_program'.$program['id'].'" class="accordion-toggle" width="5%">'.$urusan['kode'].'.'.$program['kode'].'</td>
                    <td data-bs-toggle="collapse" data-bs-target="#program_program'.$program['id'].'" class="accordion-toggle" width="40%">
                        '.$program['deskripsi'];
                        $cek_program_rjmd = ProgramRpjmd::where('program_id', $program['id'])->where('status_program', 'Prioritas')->first();
                        if($cek_program_rjmd)
    ...
    public function indikator_kinerja_tambah(Request $request)
    {
        ...
        if($request->nav_nomenklatur_program_tahun == 'semua')
        {
            $getProgram = Program::find($request->indikator_kinerja_program_program_id);
            $program = [
                'id' => $getProgram->id,
                'kode' => $getProgram->kode,
                'deskripsi' => $getProgram->deskripsi
    ...
    public function indikator_kinerja_hapus(Request $request)
    {
        ...
        if($request->nav_nomenklatur_program_tahun == 'semua')
        {
            $getProgram = Program::find($request->program_id);
            $program = [
                'id' => $getProgram->id,
                'kode' => $getProgram->kode,
                'deskripsi' => $getProgram->deskripsi
    ...
    public function indikator_kinerja_update(Request $request)
    {
        ...
        if($request->nav_nomenklatur_program_tahun == 'semua')
        {
            $getProgram = Program::find($program_indikator_kinerja->program_id);
            $program = [
                'id' => $getProgram->id,
                'kode' => $getProgram->kode,
                'deskripsi' => $getProgram->deskripsi
            ...
            return response()->json(['success' => 'Berhasil merubah indikator program','html' => $html, 'program_id' => $getProgram->id]);
        } else {
            $getProgram = Program::find($program_indikator_kinerja->program_id);
            $program = [
                'id' => $getProgram->id,
    ...
    public function opd_indikator_kinerja_hapus(Request $request)
    {
        ...
        if($request->nav_nomenklatur_program_tahun == 'semua')
        {
            $getProgram = Program::find($request->hapus_opd_indikator_program_program_id);
            $program = [
                'id' => $getProgram->id,
                'kode' => $getProgram->kode,
                'deskripsi' => $getProgram->deskripsi
            ...
            return response()->json(['success' => 'Berhasil menghapus opd dari indikator program','html' => $html, 'program_id' => $program['id']]);
        } else {
            $getProgram = Program::find($request->hapus_opd_indikator_program_program_id);
            $program = [
                'id' => $getProgram->id,
    ...
    public function opd_indikator_kinerja_update(Request $request)
    {
        ...
        if($request->nav_nomenklatur_program_tahun == 'semua')
        {
            $getProgram = Program::find($request->tambah_opd_indikator_program_program_id);
            $program = [
                'id' => $getProgram->id,
                'kode' => $getProgram->kode,
                'deskripsi' => $getProgram->deskripsi
            ...
            return response()->json(['success' => 'Berhasil mengubah opd dari indikator program','html' => $html, 'program_id'=>$program['id']]);
        } else {
            $getProgram = Program::find($request->tambah_opd_indikator_program_program_id);
            $program = [
                'id' => $getProgram->id,
    ...
    {
        $urusanId = Program::find($request->hapus_program_id)->urusan_id;
        ...
        if($request->nav_nomenklatur_program_tahun == 'semua')
        {
            $getUrusan = Urusan::find($urusanId);
            $urusan = [
                'id' => $getUrusan->id,
                'kode' => $getUrusan->kode,
                'deskripsi' => $getUrusan->deskripsi
            ...
            return response()->json(['success' => 'Berhasil menghapus program','html' => $html, 'urusan_id' => $urusanId]);
        } else {
            $getUrusan = Urusan::find($urusanId);
            $urusan = [
                'id' => $getUrusan->id,
